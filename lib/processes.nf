process prepare_spark_work_dir {
    container = params.spark_container_name == 'stitching' ? 'docker.io/mingxiaowei/stitching:1.4.0' : "${params.spark_container_repo}/${params.spark_container_name}:${params.spark_container_version}"
    label 'small'
...
process wait_for_master {
    container { 
        params.spark_container_name == 'stitching' ? 'docker.io/mingxiaowei/stitching:1.4.0' : "${params.spark_container_repo}/${params.spark_container_name}:${params.spark_container_version}" }
    label 'small'
